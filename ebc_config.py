...
def cr_window(proto, reflex=None):
    ...
    # probe comparable with the paired trials around it - but neither edge can mean "UR",
    # because there was no US to react to.
    out["cr_no_us_label"] = "CR (no US on this trial)"
    out["late_no_us_label"] = "late response (no US on this trial)"
